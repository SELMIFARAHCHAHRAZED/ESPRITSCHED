...
def calendar_view(request):
    ...
    matiere_colors = {
        ...
        'Algorithms 1': '#7D0552',
        'Algorithms 2': '#3357FF',
        'Financial Analysis': '#FF8C00',
        'Numerical Analysis': '#191970',
        'Microcontroller Architecture': '#FF5733',
        'Database': '#33FF57',
        'CCNA': '#3357FF',
        'Scientific computing': '#FF33A5',
        'Communication, Culture and Citizenship A1': '#33FFF3',
        'Communication, Culture and Citizenship A2': '#FF5733',
        'Communication, Culture and Citizenship A3': '#33FF57',
        'Communication, Culture and Citizenship F1': '#3357FF',
        'Communication, Culture and Citizenship F2': '#FF33A5',
        'Communication, Culture and Citizenship F3': '#33FFF3',
        'Object-oriented design and Java Programming': '#F5E216',
        'Business Environment and strategies': '#33FF57',
        'Network fundamentals': '#3357FF',
        'Software Engineering and Case Tools:GL': '#FF33A5',
        'IPNet routing': '#33FFF3',
        'Photo and video editing': '#FF5733',
        'Unified Modeling Language UML': '#33FF57',
        'Fundamentals of Math 1': '#3357FF',
        'Fundamentals of Math 2': '#FF33A5',
        'Fundamentals of Math 3': '#007C80',
        'Fundamentals of Math 4': '#FF5733',
        'Object-Oriented Programming using C++': '#33FF57',
        'Procedural Programming 1': '#3357FF',
        'Procedural Programming 2': '#FF33A5',
        'Programming for Mobile Terminals': '#33FFF3',
        'Communication Networks': '#FF5733',
        'Switched Network': '#33FF57',
        'IP essentials': '#3357FF',
        'Database Management System:SGBD': '#E3F9A6',
        'Computer Systems and Networks': '#33FFF3',
        'Systems and Scripting': '#FF5733',
        'Estimation Techniques for Engineers': '#33FF57',
        'Web Technologies 2.0': '#3357FF',
        'Language Theory:TLA': '#FF33A5',
        'Electronics': '#A0D6B4',
    }
    ...
    for progress in progress_list:
        ...
        if progress.predh == 'Half-day':
            events.append({
                'title': f'Half-day ({progress.matiere})',
            ...
            events.append({
                'title': f'Revision {progress.matiere}',
                'start': start_date.isoformat(),
                'end': end_date.isoformat(),
                'backgroundColor': matiere_color,
                'allDay': True,
    ...
    if request.method == "POST":
        ...
        if demi_journee:
            if jours == 0:
                ...
                predh_str = f"{jours} days et half-days"
        else:
            predh_str = f"{jours} days"
